...
<head>
    ...
    <link rel="stylesheet" href="{{asset('front/assets/css/vendor/fontawesome.min.css')}}" />
    <link rel="stylesheet" href="{{asset('front/assets/css/vendor/pe-icon-7-stroke.min.css')}}" />
...
<body>
                    ...
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-md-6 col-lg-3 col-xl-2 col-6">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{asset('front/assets/images/logo/logo.png')}}" alt="Site Logo" /></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
                        ...
                        <div class="col-md-6 col-lg-3 col-xl-4 col-6 justify-content-end">
                            <div class="header-actions">
                                ...
                                <a href="javascript:void(0)" class="header-action-btn header-action-btn-cart">
                                    ...
                                    <span class="header-action-num">{{Session::has('cart')?Session::get('cart')['qty']:0}}</span>
                                </a>
            ...
            <div class="cart-offcanvas-inner">
                ...
                <div class="offcanvas-cart-content">
                    ...
                    <div class="cart-product-wrapper mb-4 pb-4 border-bottom">
                        ...
                        <div class="single-cart-product">
                            <div class="cart-product-thumb">
                                <a href="single-product.html"><img src="{{asset('front/assets/images/products/small-product/1.jpg')}}" alt="Cart Product"></a>
                            </div>
                    ...
                    <div class="cart-product-wrapper mb-4 pb-4 border-bottom">
                        ...
                        <div class="single-cart-product">
                            <div class="cart-product-thumb">
                                <a href="single-product.html"><img src="{{asset('front/assets/images/products/small-product/2.jpg')}}" alt="Cart Product"></a>
                            </div>
                            <div class="cart-product-content">
                    ...
                    <div class="cart-product-btn mt-4">
                        <a href="{{route('front.cart')}}" class="btn btn-light btn-hover-primary w-100"><i class="fa fa-shopping-cart"></i> View cart</a>
                        <a href="{{route('front.checkout')}}" class="btn btn-light btn-hover-primary w-100 mt-4"><i class="fa fa-share"></i> Checkout</a>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12 text-center">
                        <div class="copyright-content">
                            <p class="mb-0">© 2023 <strong>American Cart </strong> Made with <i class="fa fa-heart text-danger"></i> by <a href="#">@Brand.</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{asset('front/assets/js/plugins/lightgallery-all.min.js')}}"></script>
