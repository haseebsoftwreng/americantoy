                ...
                <div class="product-details-img">
                    ...
                    <div class="single-product-img swiper-container product-gallery-top">
                        <div class="swiper-wrapper popup-gallery">
                            ...
                            <a class="swiper-slide w-100" href="{{asset($image->path)}}">
                                <img class="w-100" src="{{asset($image->path)}}" alt="Product" height="500">
                            </a>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="single-product-thumb swiper-container product-gallery-thumbs">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img src="{{asset($image->path)}}" alt="Product" height="100"
                                width="100">
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="product_tab_content border p-3">
                            ...
                            <div class="single-review d-flex mb-4">
                                ...
                                <div class="review_thumb">
                                    <img alt="review images" src="{{asset('front/assets/images/review/1.jpg')}}">
                                </div>
                                <!-- Review Thumb End -->
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{asset($product->images->first()->path)}}" alt="Product"  height="282"
                                                width="228"/>
                                                <img class="second-image fit-image" src="{{asset($product->images->first()->path)}}" alt="Product"height="282"
                                                width="228" />
                                            </a>
                                            <span class="badges">
