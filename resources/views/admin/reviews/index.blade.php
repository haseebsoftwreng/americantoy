...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">Products Reviews</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
</ol>
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i>Products Reviews
    </h1>
</div>
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($review->status == false)
                                    <a href="{{route('admin.review.edit',$review->id)}}"><button type="button" class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn">
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-danger waves-effect waves-themed deleteBtn" data-toggle="modal" data-target="#delete_modal" id="{{$review->id}}">
