...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">Payment Pending</li>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Payment Pending orders <span class="fw-300"><i>listing</i></span>
                </h2>
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.show.pending',$order->id)}}"><button type="button" class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn">
