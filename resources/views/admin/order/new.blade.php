...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">New Order Listing</li>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    New Order <span class="fw-300"><i>listing</i></span>
                </h2>
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.order.show',$order->id)}}"><button type="button" class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn">
                                        <span class="fal  fa-edit mr-1"></span>
                                        Details
                                    </button></a>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-danger waves-effect waves-themed deleteBtn" data-toggle="modal" data-target="#delete_modal" id="{{$order->id}}">
