...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i>Slider Images
    </h1>
</div>
<div class="row">
    <div class="col-xl-6">
        ...
        <div id="panel-2" class="panel">
            <div class="panel-hdr">
                <h2>
                    ADD <span class="fw-300"><i>Slider Image</i></span>
                </h2>
               
            </div>
            <div class="panel-container show">
                <div class="panel-content">
                    <form autocomplete="off" action="{{route('admin.slider.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="inputEmail3">Text</label>
                            <input type="text" name="text" class="form-control" id="inputEmail3" required>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3">Product ID</label>
                            <select  name="product_id" class="form-control" id="inputEmail3" >
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @else 
                                   <td> No Product Attached</td>
                                @endif

                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn" data-toggle="modal" data-target="#edit_modal" text="{{$slider->text}}" id="{{$slider->id}}" title="{{$slider->title}}" product_id="{{$slider->product_id}}" >
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-danger waves-effect waves-themed deleteBtn" data-toggle="modal" data-target="#delete_modal" id="{{$slider->id}}">
                ...
                <form id="myForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select  name="product_id" class="form-control" id="product_id" >
                            <option selected value="null">No Product</option>
                            @foreach (App\Models\Product::all() as $product)
                                <option value="{{$product->id}}">{{$product->name}}</option>
                            @endforeach
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('body').on('click', '.edit-btn', function(){
            ...
            $('#myForm').attr('action','{{route("admin.slider.update",'')}}' + '/' +id);
        });
