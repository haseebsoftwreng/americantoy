...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">Completed Order Listing</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
</ol>
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i>Order
    </h1>
</div>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Completed Order <span class="fw-300"><i>listing</i></span>
                </h2>
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('admin.order.show',$order->id)}}"><button type="button" class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn">
                                    <span class="fal  fa-edit mr-1"></span>
                                    Details
                                </button></a></td>
                                <td>
                                    <form action="{{route('admin.new.mail.view')}}" method="POST">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$order->id}}">
                                        <button type="submit" class="btn btn-sm btn-outline-success waves-effect waves-themed">Send Mail   
                                        </button>
                                    </form> 
                                </td>
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('body').on('click', '.deleteBtn', function(){
            let id = $(this).attr('id');
            $('#id').val(id);
            $('#deleteForm').attr('action','{{route('admin.order.update','')}}' +'/'+id);
        });
