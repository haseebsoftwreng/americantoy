 ...
 <ol class="breadcrumb page-breadcrumb">
     ...
     <li class="breadcrumb-item"> Deleted Products</li>
 ...
 <div class="row">
     <div class="col-xl-12">
         <div id="panel-1" class="panel">
             <div class="panel-hdr">
                 <h2>
                     Products <span class="fw-300"><i>Deleted</i></span>
                 </h2>
                 ...
                 <div class="panel-content">
                     ...
                     <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 <td>{{$key+1}}</td>
                                 <td><img src="{{asset($product->images->first()->path)}}" alt="image" height="60" width="60"></td>
                                 <td>{{$product->name}}</td>
                                 <td>{{$product->price}}</td>
                                 ...
                                 <td>{{$product->order}}</td>
                                 {{-- <td>
                                     <a href="{{route('admin.product.edit',$product->id)}}"><button type="button" class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn" data-toggle="modal" data-target="#edit_modal"  id="{{$product->id}}" >
                                         <span class="fal  fa-edit mr-1"></span>
                                         Edit
                                     </button></a>
                                 </td> --}}
                                 <td>
                                     <button type="button" class="btn btn-sm btn-outline-success waves-effect waves-themed deleteBtn" data-toggle="modal" data-target="#restore_modal" >
                                 ...
                                 <td>
                                     <button type="button" class="btn btn-sm btn-outline-danger waves-effect waves-themed deleteBtn" data-toggle="modal" data-target="#delete_modal">
                                         Delete
                                     </button>
                                 </td>
                             </tr>

                             <div class="modal fade" id="restore_modal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        
                                        <form id="deleteForm" action="{{ route('admin.product.restore',$product->id) }}" method="get">
                                            @csrf
                            ...
                            <div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="deleteForm" action="{{ route('admin.product.delete',$product->id) }}" method="get">
                                            @csrf
