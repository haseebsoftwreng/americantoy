...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">Products Listing</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
</ol>
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i>Products
    </h1>
</div>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Products <span class="fw-300"><i>listing</i></span>
                </h2>
                ...
                <div class="panel-content">
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$key+1}}</td>
                                <td><img src="{{asset($product->images->first()->path)}}" alt="image" height="60"
                                        width="60"></td>
                                <td>{{$product->name}} / Color: {{$product->color}}</td>
                                <td>{{$product->price}}</td>
                                ...
                                <td id="feature-{{$product->id}}">
                                    @if ($product->featured == 1)       
                                    
                                    
                                        <button
                                        class="btn btn-danger btn-sm waves-effect featureBtn" productid="{{$product->id}}">
                                    ...
                                    @else
                                             <button
                                    class="btn btn-success btn-sm waves-effect featureBtn" productid="{{$product->id}}">
                                            <span class="fal fa-star mr-1"></span>                        
                                            Feature
                                    </button>      
                                            @endif
                                ...
                                <td>
                                    <a  target="_blank" href="{{$product->link}}"><button type="button"
                                ...
                                <td>
                                    <a href="{{route('admin.product.edit',$product->id)}}"><button type="button"
                                            class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn"
                                            data-toggle="modal" data-target="#edit_modal" id="{{$product->id}}">
                                            <span class="fal  fa-edit mr-1"></span>
                                            Edit
                                        </button></a>
                                </td>
                                <td>
                                    <button type="button"
                                        class="btn btn-sm btn-outline-danger waves-effect waves-themed deleteBtn"
                                        data-toggle="modal" data-target="#delete_modal" id="{{$product->id}}">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.featured == 1) {
                        $('#feature-'+id).append(
                            '<button class="btn btn-danger btn-sm waves-effect featureBtn" productid="'+id+'">'+
                            '<span class="fal fa-star mr-1">'+
                            '</span>'+                     
                            'unfeature'+
                            '</button>'
                                )
                    }
                   else if (response.featured == 0) {
                    $('#feature-'+id).append(
                            '<button class="btn btn-success btn-sm waves-effect featureBtn" productid="'+id+'">'+
                                            '<span class="fal fa-star mr-1">'+
                                            '</span>'+                      
                                            'feature'+
                                    '</button>')
