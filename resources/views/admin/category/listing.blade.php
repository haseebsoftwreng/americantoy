                ...
                <div class="panel-content">
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$key+1}}</td>
                                <td><img src="{{asset($category->image)}}" alt="category image" height="60" width="60"></td>
                                <td>{{$category->name}}</td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-info waves-effect waves-themed edit-btn" data-toggle="modal" data-target="#edit_modal" name="{{$category->name}}" id="{{$category->id}}" >
                                        <span class="fal  fa-edit mr-1"></span>
                                        Edit
                                    </button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-danger waves-effect waves-themed deleteBtn" data-toggle="modal" data-target="#delete_modal" id="{{$category ->id}}">
