...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">Attribute Options</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
</ol>
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i>{{$attribute->name}} Option
    </h1>
    <button type="button" class="btn btn-primary btn-pills waves-effect waves-themed" data-toggle="modal" data-target="#option_modal"><span class="fal fa-plus mr-1"></span>Add Options</button>
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$option->option}}</td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-danger waves-effect waves-themed deleteBtn" data-toggle="modal" data-target="#delete_modal" id="{{$option->id}}">
...
<div class="modal fade" id="option_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="myForm" method="POST" action="{{route('admin.option.store')}}">
                    @csrf
                    <div class="form-group">
                      <label for="name" class="col-form-label">Name</label>
                      <input type="text" name="option" class="form-control" id="name" required>
                    </div>
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('body').on('click', '.deleteBtn', function(){
            let id = $(this).attr('id');
            $('#id').val(id);
            $('#deleteForm').attr('action','{{route('admin.option.destroy','')}}' +'/'+id);
        });
